package com.sitimaeturoh.uas;

public class Konfigurasi {

    public static final String URL_ADD = "http://192.168.11.1/from/tambah.php";
    public static final String URL_GET_ALL = "http://192.168.11.1/from/lihat.php";
